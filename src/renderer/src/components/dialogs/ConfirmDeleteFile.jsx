...
import { deletePatientFiles } from '../../util/apis/patientsPostAPIs'
...
export default function ConfirmDeleteFile() {
  ...
  return (
    <React.Fragment>
      <Dialog
        open={open === 'deletePatientFileConfirmation'}
        onClose={handleClose}
        aria-labelledby="alert-dialog-title"
        aria-describedby="alert-dialog-description"
      >
        <DialogTitle id="alert-dialog-title">{'مسح الحالة'}</DialogTitle>
        <DialogContent> هل أنت متأكد من مسح ملف هذه الحالة؟</DialogContent>
        <DialogActions>
